            ...
            <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
                ...
                >
                    ...
                    <ul className="text-sm text-[#8B7355] space-y-2 leading-relaxed">
                        ...
                        <li className="flex items-start">
                            <span className="mr-2 text-[#5C4B37]">•</span>
                            Memberikan pengalaman berbelanja terbaik
                        </li>
                        <li className="flex items-start">
                            <span className="mr-2 text-[#5C4B37]">•</span>
                ...
                >
                    ...
                    <div className="grid sm:grid-cols-3 gap-3">
                        <div className="p-3 rounded-lg bg-white border border-[#EDE3CD]">
                            <h3 className="text-sm font-medium text-[#5C4B37] mb-1">Kemudahan Transaksi</h3>
                            <p className="text-xs text-[#8B7355]">Proses jual beli yang simpel dan aman untuk semua pengguna</p>
                        </div>
                        <div className="p-3 rounded-lg bg-white border border-[#EDE3CD]">
                            <h3 className="text-sm font-medium text-[#5C4B37] mb-1">Komunitas Aktif</h3>
                            <p className="text-xs text-[#8B7355]">Terhubung dengan komunitas penjual dan pembeli yang positif</p>
                        </div>
                        <div className="p-3 rounded-lg bg-white border border-[#EDE3CD]">
                            <h3 className="text-sm font-medium text-[#5C4B37] mb-1">Dukungan 24/7</h3>
                            <p className="text-xs text-[#8B7355]">Layanan pelanggan yang siap membantu setiap saat</p>
                        </div>
                    </div>
                </motion.div>
            </div>
