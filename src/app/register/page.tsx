    ...
    <div className="flex min-h-[80vh] items-center justify-center bg-[#FDF6E3] px-4 py-12">
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-[#EDE3CD]">
        <div className="text-center">
          <h2 className="text-2xl font-bold tracking-tight text-[#5C4B37]">Buat Akun Baru</h2>
          <p className="mt-2 text-sm text-[#8B7355]">Bergabung untuk mendapat kemudahan berbelanja</p>
        </div>
        ...
        <p className="text-center text-sm text-[#8B7355] mt-6">
          Sudah punya akun?{' '}
          <Link href="/login" className="font-bold text-[#5C4B37] hover:text-[#3D3224] hover:underline transition-colors">
            Masuk di sini
          </Link>
        </p>
      </div>
